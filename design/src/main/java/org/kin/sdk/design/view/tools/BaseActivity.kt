...
abstract class BaseActivity<ViewModelType : ViewModel<ArgsType, StateType>, ArgsType, StateType, ResolverType : Resolver, NavigatorType : Navigator> :
    AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        resolver.activityResultSink?.onNewResult(requestCode, data)
    }

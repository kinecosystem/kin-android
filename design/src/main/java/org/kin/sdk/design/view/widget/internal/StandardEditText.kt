...
import org.kin.sdk.design.view.tools.LineDrawable
import org.kin.sdk.design.view.tools.dip
import org.kin.sdk.design.view.tools.resolveColor
import org.kin.sdk.design.view.tools.selectableItemBackgroundBorderlessResource
...
class StandardEditText @JvmOverloads constructor(
    ...
    val innerEditText: EditText by lazy {
        EditText(context).apply {
            ...
            setHintTextColor(context.resolveColor(R.color.kin_sdk_secondaryTextColor))
...
//            underlineView.background = LineDrawable(context.context.resolveColor(R.color.secondaryTextColor))
        }
    }
...
//                }
                context.resolveColor(R.color.kin_sdk_secondaryTextColor)
            )
        }
    }
    ...
    private fun reconfigureUnderline() {
        val lineColor = when {
            state == State.ERROR -> context.resolveColor(R.color.kin_sdk_destructiveColor)
            innerEditText.hasFocus() -> context.resolveColor(R.color.kin_sdk_primaryTextColor)
            else -> context.resolveColor(R.color.kin_sdk_secondaryTextColor)
        }

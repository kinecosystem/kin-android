...
data class PaymentInfoImpl(val kinPayment: KinPayment) : PaymentInfo {
    ...
    override fun destinationPublicKey(): String = kinPayment.destinationAccountId.encodeAsString()
    override fun sourcePublicKey(): String = kinPayment.sourceAccountId.encodeAsString()

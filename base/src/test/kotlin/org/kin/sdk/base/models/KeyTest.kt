...
class KeyTest {
    ...
    fun testEquality() {
        ...
        assertEquals(privateKey1.encode(), Key.PrivateKey(privateKey1.value).encode())
        ...
        assertEquals(publicKey4.encode(), Key.PublicKey(publicKey4.value).encode())
        ...
        assertEquals(privateKey1, Key.PrivateKey.decode(privateKey1.encode()))
        assertEquals(publicKey4, Key.PublicKey.decode(publicKey4.encode()))
    }
}

...
class SubmitTransactionResponseTest {
    @Test
    fun testDeserializeTransactionFailureResponse() {
        val json = "{\n" +
    ...
    @Test
    fun testDeserializeOperationFailureResponse() {
        val json = "{\n" +
                "  \"type\": \"https://stellar.org/horizon-errors/transaction_failed\",\n" +
                "  \"title\": \"Transaction Failed\",\n" +
                "  \"status\": 400,\n" +
    ...
    fun testDeserializeSuccessResponse() {
        ...
        assertEquals(submitTransactionResponse.ledger, 3128812L)
        assertEquals(
            submitTransactionResponse.getEnvelopeXdr(),
        ...
        assertEquals(submitTransactionResponse.getOfferIdFromResult(0), 241L)
    }

    @Test
    fun testDeserializeNoOfferID() {
        val json = "{\n" +
                "  \"_links\": {\n" +
                "    \"transaction\": {\n" +
                "      \"href\": \"https://horizon-testnet.stellar.org/transactions/ee14b93fcd31d4cfe835b941a0a8744e23a6677097db1fafe0552d8657bed940\"\n" +
